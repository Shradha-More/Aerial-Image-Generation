...
A possible high-level organization of the project is:

``` text
aerial-image-restoration/
│
├── data/
│   ├── raw/
│   ├── partial/
...
1.  Acquire or load aerial/UAV imagery.
2.  Preprocess the image and identify degradation.
3.  Estimate the blur PSF using available UAV/camera telemetry.
4.  Apply image restoration/deblurring.
5.  Run monocular depth estimation.
6.  Recover an appropriate metric scale.
7.  Generate a 3D point cloud using Open3D.
8.  Explore mesh/implicit 3D reconstruction.
9.  Optimize selected models for deployment.
10. Present the restored image and reconstruction results through the
    offline interface.
...
-   Low-bandwidth aerial image transmission
...
This work was carried out as part of an AI and research
internship/project focused on computer vision and aerial imagery.

## Author

**Shraddha More**

AI & Data Science \| Computer Vision \| Deep Learning \| AI/ML
